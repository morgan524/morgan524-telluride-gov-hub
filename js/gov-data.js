...
const SMART_CACHE_DATE = '2026-07-23';
...
const MV_CACHE_DATE = '2026-07-23';
...
const MED_CACHE_DATE = '2026-07-23';
...
const NORWOOD_CACHE_DATE = '2026-07-23';
...
const OPHIR_CACHE_DATE = '2026-07-23';
...
const RIDGWAY_CACHE_DATE = '2026-07-23';
...
const LAND_USE_ISSUES = {
  carhenge: {
    ...
    statusTitle: 'Carhenge is deep in formal land use review — story poles are down, HARC has held its hearings, and P&Z takes up the subdivision and PUD on July 23.',
    statusCopy: 'After a March P&Z work session and a May 20 HARC work session, story poles stood on the 700 W Pacific lot July 6–17 so the community could see the proposed heights and massing. On July 15 HARC held Preliminary Large-Scale public hearings on the eight proposed buildings (A through E) on Lots 34 and 34B. Next is the July 23 Planning & Zoning hearing on the subdivision that would consolidate the two lots and the Conceptual PUD for the new construction. Shandoka (Lot L) is moving on a parallel track. The key public questions remain density, design, actual affordability, neighborhood fit, parking, traffic, and flood/groundwater — the grounds the Chair 7 Community Coalition is contesting.',
    nextStep: 'Carhenge Planning & Zoning hearing: July 23, 2026 at Rebekah Hall (113 W Columbia Ave) and on Zoom — a Preliminary Large Scale Subdivision to consolidate Lots 34 and 34B plus a Conceptual PUD for the new construction (carried over from May). The next regular P&Z is August 27.',
    metrics: [
    ...
    timeline: [
      ...
      { date: 'May 2026', title: 'Chair 7 Coalition files legal challenges; Carhenge tabled to July 23', copy: 'Through counsel Diane Wolfson (Sphere Law Firm), the Chair 7 Community Coalition submitted seven letters to the Town and P&Z opposing the Carhenge and Shandoka PUDs on parking, traffic, flood and groundwater, and Backman Village Plat grounds — all seven are linked under Key Documents below. At the May 29 hearing the Commission tabled the Carhenge application to the July 23, 2026 P&Z meeting; the Shandoka work session is set for June 25, 2026.' },
      { date: 'Jul 6–17, 2026', title: 'Story poles go up on the Carhenge lot', copy: 'The Town erected story poles across the 700 W Pacific parking lot from July 6 to July 17 (closing the lot during that window) so residents could see the proposed building heights and massing before the formal hearings.' },
      { date: 'Jul 15, 2026', title: 'HARC public hearing on the eight buildings', copy: 'The Historic & Architectural Review Commission held Preliminary Large-Scale public hearings on the proposed Buildings A, B, C, D1, D2, E1, E2 and E3 on Lots 34 and 34B — all new construction in the Accommodations 2 zone (outside the Historic Landmark District), with Design Workshop as applicant and the Town as owner. A Shandoka Lot work session followed.' },
      { date: 'Jul 23, 2026', title: 'P&Z takes up the subdivision and Conceptual PUD', copy: 'Planning & Zoning hears the Carhenge Preliminary Large Scale Subdivision — consolidating Lots 34 and 34B into a single parcel of just over 15,000 sq ft — and a Conceptual PUD for the new construction, carried over from May. Formal PUD, Subdivision, and Large Scale Activity hearings, then Town Council, still lie ahead.', future: true }
    ],
    docs: [
      { title: 'Carhenge Lot Ground Study (June 2026)', copy: 'The Town-commissioned geotechnical and groundwater study of the 700 W Pacific site — directly relevant to the flood-zone and shallow-groundwater questions raised about the proposed below-grade parking.', tag: 'Carhenge', href: 'https://engagetelluride.org/32089/widgets/113355/documents/83231' },
      { title: 'C7CC — Summary of Legal Issues (June 2026)', copy: 'Chair 7 Community Coalition overview of the seven legal letters its counsel (Diane Wolfson, Sphere Law Firm) filed opposing the Carhenge and Shandoka PUD applications — covering parking, traffic, flood and groundwater hazards, and the Backman Village Plat restrictions.', tag: 'C7CC', href: 'https://firebasestorage.googleapis.com/v0/b/telluride-gov-hub.firebasestorage.app/o/deep-dive-docs%2Fchair-7%2Fchair7-summary-of-legal-issues.pdf?alt=media&token=36937ed8-1f92-447f-b520-16cf94d56aa6' },
      { title: 'C7CC — Shandoka: Traffic (Letter to P&Z, May 28 2026)', copy: 'Identifies trip generators the existing studies never modeled — a transit center and a childcare facility with high, concentrated peak-hour traffic — and asks the Commission to decline a favorable circulation finding without a development-specific traffic study.', tag: 'C7CC', href: 'https://firebasestorage.googleapis.com/v0/b/telluride-gov-hub.firebasestorage.app/o/deep-dive-docs%2Fchair-7%2Fchair7-shandoka-traffic.pdf?alt=media&token=26c50b31-37e2-476f-bddc-ceedcba8b784' },
      { title: 'C7CC — Carhenge: Parking (Letter to P&Z, May 27 2026)', copy: 'Argues the 225–235 spaces understate Code requirements, and that the project relocates the roughly 288 intercept-parking spaces that justify its low one-space-per-unit minimum; asks P&Z to hold the application pending a real parking-demand analysis.', tag: 'C7CC', href: 'https://firebasestorage.googleapis.com/v0/b/telluride-gov-hub.firebasestorage.app/o/deep-dive-docs%2Fchair-7%2Fchair7-carhenge-parking.pdf?alt=media&token=7e69811d-e42b-4180-a6db-3f1573b9838f' },
      { title: 'C7CC — Carhenge: Traffic (Letter to P&Z, May 27 2026)', copy: 'Contends the traffic record is inadequate — the 2020 study and 2025 update modeled a different project and never analyzed the 10,000 sq ft of commercial use or peak school hours — and notes the Davis Street / West Colorado Avenue exit is already failing at Level of Service F.', tag: 'C7CC', href: 'https://firebasestorage.googleapis.com/v0/b/telluride-gov-hub.firebasestorage.app/o/deep-dive-docs%2Fchair-7%2Fchair7-carhenge-traffic.pdf?alt=media&token=4f2ad7e8-7912-42d1-a2b2-94c6c42b5a2a' },
      { title: 'C7CC — Carhenge: Flood Hazards and Ground Water (Letter to P&Z, May 27 2026)', copy: 'Flags that much of the site sits in FEMA Zone AE and a shallow-groundwater zone, yet the plan proposes multi-level basement parking — a configuration counsel argues is barred by NFIP rules and LUC Section 8-622.D, and that the project may not be buildable as drawn.', tag: 'C7CC', href: 'https://firebasestorage.googleapis.com/v0/b/telluride-gov-hub.firebasestorage.app/o/deep-dive-docs%2Fchair-7%2Fchair7-carhenge-flood-groundwater.pdf?alt=media&token=8c3550f6-8665-4803-bf43-470e9afeb9d4' },
      { title: 'C7CC — Carhenge: Backman Village Plat (Letter to Town of Telluride, May 27 2026)', copy: 'Argues the Backman Village Plat caps Lots 34 and 34-B at 141 multifamily units versus the proposed 220–230, and that consolidating the lots requires a plat amendment needing unanimous owner consent the Coalition will withhold — which counsel calls a literally futile posture.', tag: 'C7CC', href: 'https://firebasestorage.googleapis.com/v0/b/telluride-gov-hub.firebasestorage.app/o/deep-dive-docs%2Fchair-7%2Fchair7-carhenge-backman-plat.pdf?alt=media&token=1f7eec13-01fc-4d9d-ad7a-f8eeb22b4147' },
      { title: 'C7CC — Shandoka: Backman Village Plat and 1987 Dedication Deed (Letter to Town of Telluride, May 27 2026)', copy: 'The strongest Shandoka argument: the only permitted use for Lot L is parking to serve the surrounding lots, and a recorded 1987 Dedication Deed restricts it to public parking, transportation, access, and river and trail corridors — not the proposed housing, commercial space, or transit center.', tag: 'C7CC', href: 'https://firebasestorage.googleapis.com/v0/b/telluride-gov-hub.firebasestorage.app/o/deep-dive-docs%2Fchair-7%2Fchair7-shandoka-backman-plat.pdf?alt=media&token=43ec3390-a003-4fc5-8961-e6fc0e762af1' },
    ...
    meetings: [
      { date: 'Jul 23, 2026', time: '5:30 PM', title: 'P&Z Hearing — Carhenge Subdivision & Conceptual PUD', source: 'Town of Telluride', location: 'Hybrid / Rebekah Hall, 113 W Columbia Ave', href: 'https://telluride-co.civicweb.net/Portal/MeetingInformation.aspx?Id=8100', zoom: '' },
      { date: 'Aug 27, 2026', title: 'Planning & Zoning Commission — next regular meeting', source: 'Town of Telluride', location: 'Hybrid / Rebekah Hall, 113 W Columbia Ave', href: 'https://telluride-co.civicweb.net/Portal/MeetingInformation.aspx?Id=8102', zoom: '' }
    ],
    players: [
  ...
  code: {
    ...
    statusTitle: 'The Final Code Audit Report is out -- the first full picture of the proposed Land Use Code changes.',
    ...
    nextStep: 'Read the Final Code Audit Report (public draft, July 2026) on the County project page -- it contains the actual proposed code amendments, zone by zone. The SSR meets again July 27. Comments go to housingupdate@sanmiguelcountyco.gov before the Planning Commission and BOCC take up adoption this fall.',
    controversyUpdate: {
      date: 'May 14, 2026',
    ...
    news: [
      { source: 'Telluride Times', date: 'Jul 19, 2026', title: 'Stakeholders discuss housing density', copy: 'Coverage of the SSR\'s sixth meeting (July 16): workforce housing types, zoning, and density against a projected countywide need of ~1,100 units by 2030 -- with density bonuses for deed-restricted projects on the table and no recommendations finalized yet.', href: 'https://www.telluridenews.com/news/article_3fa56ff6-1d64-4c3b-b271-0802fcb74db2.html' }
    ],
    docs: [
      { title: 'Final Code Audit Report & Recommendations (public draft, July 2026)', copy: 'The full proposed Land Use Code changes -- lot sizes, density and bonuses, setbacks, housing types, the Community Housing zone rewrite, and Appendix A code redlines. Posted in the project document center.', tag: 'Key Document', href: 'https://www.sanmiguelcountyco.gov/882/Housing-Code-Update' },
      ...
      { title: 'April SSR No. 5 Meeting Packet', copy: 'Fifth and most recent SSR meeting packet (April 2026). High-level summary not yet posted by SMC at the time of writing.', tag: 'SSR No. 5', href: '/assets/ssr/14206-April-SSR-No-5-Meeting-Packet.pdf' },
      { title: 'March SSR No. 4 Meeting Packet', copy: 'Fourth SSR meeting packet (March 2026). This is where the Accelerated Housing Review draft language was substantively reworked.', tag: 'SSR No. 4', href: '/assets/ssr/13938-March-SSR-No-4-Meeting-Packet.pdf' },
      { title: 'March SSR No. 4 Meeting High-Level Summary', copy: 'Short summary of what was discussed and decided at SSR No. 4.', tag: 'SSR No. 4 Summary', href: '/assets/ssr/14065-March-SSR-No-4-Meeting-High-Level-Summary.pdf' },
      { title: 'January SSR No. 3 Meeting Packet', copy: 'Third SSR meeting packet (January 2026).', tag: 'SSR No. 3', href: '/assets/ssr/13846-January-SSR-No-3-Meeting-Packet.pdf' },
      { title: 'January SSR No. 3 Meeting High-Level Summary', copy: 'Short summary of what was discussed and decided at SSR No. 3.', tag: 'SSR No. 3 Summary', href: '/assets/ssr/13883-January-SSR-No-3-High-Level-Summary.pdf' },
      { title: 'December SSR No. 2 Meeting Packet', copy: 'Second SSR meeting packet (December 2025).', tag: 'SSR No. 2', href: '/assets/ssr/13733-December-SSR-No-2-Meeting-Packet.pdf' },
      { title: 'December SSR No. 2 Meeting High-Level Summary', copy: 'Short summary of what was discussed and decided at SSR No. 2.', tag: 'SSR No. 2 Summary', href: '/assets/ssr/13810-December-SSR-No-Meeting-High-Level-Summary.pdf' },
      { title: 'October SSR No. 1 Meeting Packet', copy: 'First SSR meeting packet (October 2025). Typically the largest packet because it sets up baseline existing-code review.', tag: 'SSR No. 1', href: '/assets/ssr/13732-October-SSR-No-1-Meeting-Packet.pdf' },
      { title: 'October SSR No. 1 Meeting High-Level Summary', copy: 'Short summary of what was discussed and decided at SSR No. 1.', tag: 'SSR No. 1 Summary', href: '/assets/ssr/13734-October-SSR-No-1-Meeting-High-Level-Summary.pdf' },
      { title: 'BOCC Presentation -- Community Engagement Plan', copy: 'Presentation given to the Board of County Commissioners describing the Housing Code Update community engagement strategy.', tag: 'BOCC', href: '/assets/ssr/13339-BOCC-Presentation-Community-Engagement-Plan-PDF.pdf' },
      { title: 'Community Engagement Plan', copy: 'Full Community Engagement Plan describing how the County intends to gather public input throughout the code update.', tag: 'Plan', href: '/assets/ssr/13340-Community-Engagement-Plan-PDF.pdf' },
      ...
      { title: 'San Miguel County Land Use Code (Accelerated Housing Review)', copy: 'The current Land Use Code language that the Accelerated Housing Review draft would amend. Useful for comparing existing rules against the proposed changes.', tag: 'Existing Code', href: '/assets/ssr/14055-document-14055.pdf' },
  ...
  diamond: {
    ...
    statusCopy: 'In 2022, the BOCC rushed through a rezone of 39 acres of the Diamond Ridge property from protected Forestry/Agricultural land to the CH Zone. The district court found that County Commissioner Hilary Cooper helped engineer the purchase and rezone behind the scenes, and therefore, when she refused to recuse herself from a vote on rezoning, the County denied landowners proper due process. The court also found the rezone was illegal spot zoning that ignored the Master Plan. The Town and County believe the 39 acres to be separate from the encompassing 1991 Aldasoro PUD plan, which restricts development to one home per 35 acres, and therefore made no attempt to rezone the remaining 66 acres of undisputedly PUD-protected land. Neighboring property owners dispute this belief. In a second 2024 ruling, the court confirmed that the Diamond Ranch lots are part of the 1991 Aldasoro PUD, meaning they are restricted to one home per 35 acres. However, in a later decision by a new judge on the case, the court did find the 39 acres not to be subject to the 1991 PUD. Neighboring property owners have appealed this ruling, and the County subsequently appealed the PUD ruling but has not attempted a new rezoning.',
    nextStep: 'Watch for the outcome of the appeals of the PUD-related rulings, and whether the County attempts any new rezoning or development strategy.',
    metrics: [
    ...
    timeline: [
      ...
      { date: '2021', title: 'BOCC quietly creates a new high-density zone district called the CH (Community Housing) Zone', copy: 'San Miguel County amends the Land Use Code to create the Community Housing zone allowing up to 20 units per acre -- the polar opposite of the F/Ag zoning that had protected the area for decades. The entire process was conducted by Zoom during the COVID lockdowns, with no public participation. Text messages later revealed this was coordinated with the Town\'s purchase plan.' },
      { date: '2022', title: 'Only three months after adopting the CH Zone, an application to rezone Diamond Ridge is completed, and the rezone is rushed through over objections; court strikes it down', copy: 'Despite a formal recusal request, Commissioner Cooper -- who had privately coordinated the purchase and rezone with the Town -- voted to approve the rezone 3-0. Neighboring landowners sued. In December 2022, Judge Patrick ruled in favor of the neighboring landowners and vacated (nullified) the rezone, finding a due process violation and illegal spot zoning.' },
