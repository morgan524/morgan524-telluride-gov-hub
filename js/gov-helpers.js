...
const MEETING_RECAPS = [
  {
    ...
    votes: [{"item":"Enter executive session — town manager search","outcome":"Passed","tally":""}],
...
const LEGAL_NOTICES = [
  ...
  {
    title: "RFP -- Fuel Island Canopy Construction, Norwood Road & Bridge Maintenance Yard",
  ...
  {
    title: "RFP -- Repainting of San Miguel County Jail, Illium",
