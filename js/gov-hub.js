...
const TELLURIDE_TIMES_ARTICLES = [
  {
    ...
    copy: 'The Broncos and Chiefs will open the 2026 NFL season with the first Monday Night Football game, though Chiefs QB Patrick Mahomes\' availability remains uncertain after tearing his ACL and LCL in December. Broncos QB Bo Nix is expected ready for training camp after breaking his ankle during the AFC playoffs.',
    claudeSummary: true,
  ...
  },
  {
    ...
    firstSeen: '2026-05-12',
    newsTopic: 'education',
    copy: 'Rep. Suckla wrapped up his second legislative session at the State House, passing six of nine sponsored bills including extending Rico\'s microgrid grant program and allowing Dolores County commissioners to cut their own salaries. He\'s moved from an off-site office his first year to the Capitol basement, saying he\'s still learning the ropes but focused on bringing rural perspective to Denver.',
    claudeSummary: true,
  ...
  },
  {
    ...
    firstSeen: '2026-05-12',
    newsTopic: 'community',
    copy: 'Second Chance Animal Resource Center took over operations of the Delta Animal Shelter on May 1st, replacing Roice-Hurst Humane Society in partnership with the City of Delta. The organization plans to add new programs including adoptions, foster care, and expanded pet pantry services, with longtime staff member Jeff Bohlender supervising full-time operations in Delta.',
    claudeSummary: true,
  ...
  },
  {
    ...
    firstSeen: '2026-05-12',
    newsTopic: 'arts-culture',
    copy: 'Telluride Rotary is holding their second annual Hikeathon fundraiser with a goal to raise over $30,000 this year. Other local nonprofits like Eco-Action Partners, Telluride Ski and Snowboard Club, and Telluride Jewish Community are forming teams to participate and raise funds for their own causes too.',
    claudeSummary: true,
  ...
  },
  {
    ...
    copy: 'A Frontier Airlines plane struck and killed someone on the runway at Denver International Airport during takeoff, causing an engine fire and forcing an emergency evacuation of 231 people via slides. Twelve passengers sustained minor injuries and five were hospitalized, with passengers reporting chaos as smoke filled the cabin before they evacuated onto the cold tarmac.',
    claudeSummary: true,
...
const LEGAL_NOTICES_CACHE_DATE = '2026-05-12'; // Updated by legal-notice-update task
