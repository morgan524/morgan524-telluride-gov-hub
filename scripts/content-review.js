...
async function checkAI(ctx) {
  ...
  const prompt =
    ...
    // 2026-09-24: the reviewer called Sheridan's "SummerSHOW Series" mislabeled
    // for a Sep 24 show; that is the organizer's own series name, verbatim.
    `Do NOT flag a season word in a series or brand name (e.g. "SummerSHOW Series", "Winter Concert Series") ` +
    `as mislabeled because the date falls in a different season — organizers keep the series name. ` +
